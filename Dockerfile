...
RUN wget 'https://openresty.org/download/nginx-1.19.3.tar.gz' && tar -xzvf nginx-1.19.3.tar.gz
RUN wget 'https://github.com/openresty/luajit2/archive/refs/tags/v2.1-20210510.tar.gz' && tar -xzvf v2.1-20210510.tar.gz
RUN wget 'https://github.com/vision5/ngx_devel_kit/archive/refs/tags/v0.3.1.tar.gz' && tar -xzvf v0.3.1.tar.gz
RUN wget 'https://github.com/openresty/lua-nginx-module/archive/refs/tags/v0.10.21.tar.gz' && tar -xzvf v0.10.21.tar.gz
RUN wget 'https://github.com/openresty/lua-resty-core/archive/refs/tags/v0.1.23.tar.gz' && tar -xzvf v0.1.23.tar.gz
RUN wget 'https://github.com/openresty/lua-resty-lrucache/archive/refs/tags/v0.11.tar.gz' && tar -xzvf v0.11.tar.gz
